...
const AddWishlistModal: React.FC<AddWishlistModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showError('Gagal menambahkan item', 'Silakan coba lagi');
    } finally {
      setLoading(false);
    }
  };
    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md max-h-[95vh] flex flex-col">
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Tambah Item Wishlist</h2>
          <button
            onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Tambahkan gambar untuk memvisualisasikan item yang diinginkan
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Tetapkan target waktu untuk membantu perencanaan keuangan
              </p>
            </div>
            ...
            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm text-amber-800 dark:text-amber-200">
                  <p className="font-medium mb-1">Reminder Anti-Impulsif</p>
                  <p>Sebelum membeli, tunggu minimal 24 jam dan tanyakan: "Apakah saya benar-benar membutuhkan ini?"</p>
                </div>
              </div>
            </div>
          </form>
        ...
        <div className="flex space-x-3 p-6 border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
          ...
          >
            {loading ? 'Menambahkan...' : 'Tambah ke Wishlist'}
          </button>
        </div>
      </div>
    </div>
