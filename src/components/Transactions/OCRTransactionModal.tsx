...
const OCRTransactionModal: React.FC<OCRTransactionModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-6xl w-full max-h-[95vh] flex flex-col">
        ...
        {/* Configuration Panel */}
        {showConfig && (
          <div className="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 flex-shrink-0">
