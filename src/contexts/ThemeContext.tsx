...
const translations = {
  id: {
    ...
    'manage_transactions_description': 'Kelola pemasukan dan pengeluaran Anda',
    'search_transactions': 'Cari transaksi...',
    'no_transactions': 'Tidak ada transaksi ditemukan',
    'no_transactions_description': 'Mulai dengan menambahkan transaksi pertama Anda untuk melacak keuangan.',
    'confirm_delete_transaction': 'Apakah Anda yakin ingin menghapus transaksi ini?',
    'add_transaction': 'Tambah Transaksi',
    'add_first_transaction': 'Tambah Transaksi Pertama',
    'all_types': 'Semua Jenis',
    'income': 'Pemasukan',
    'expense': 'Pengeluaran',
    'sort_by_date': 'Urutkan berdasarkan Tanggal',
    'sort_by_amount': 'Urutkan berdasarkan Jumlah',
    'category': 'Kategori',
    'account': 'Akun',
    'budget': 'Anggaran',
    'amount': 'Jumlah',
