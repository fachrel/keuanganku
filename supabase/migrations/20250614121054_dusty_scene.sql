/*
  ...
  1. Changes
    - Add 'transfer' as a valid type in the transactions table CHECK constraint
    - This allows transactions to be marked specifically as transfers rather than income/expense
    - Transfers will not be counted in income/expense reports or budget calculations
